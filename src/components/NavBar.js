...
const NavBar = () => {
  return (
    <header className="w-full px-10 py-8 font-medium flex items-center justify-between
    fixed bg-light">
      <nav>
        <CustomLink href="/" title="Home" className="mx-6" />
        ...
        <CustomLink
          ...
          className="ml-4"
        />
        <CustomLink href="/contact" title="Contact Me" className="mx-6" />
      </nav>
